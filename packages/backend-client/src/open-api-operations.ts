...
export function adminListProducts(opts?: Oazapfts.RequestOpts) {
...
export function storeCreateCart(opts?: Oazapfts.RequestOpts) {
    return oazapfts.fetchJson<{
        status: 201;
        data: InitCartDao;
    }>("/api/store/carts", {
...
export function storeGetCart(cartId: number, opts?: Oazapfts.RequestOpts) {
    return oazapfts.fetchJson<{
        status: 200;
        data: GetCartDao;
...
export function storeCreateCartLineItem(cartId: number, addLineItemDto: AddLineItemDto, opts?: Oazapfts.RequestOpts) {
    return oazapfts.fetchJson<{
        status: 201;
        data: GetCartDao;
...
export function storeDeleteCartLineItem(cartId: number, lineItemId: number, opts?: Oazapfts.RequestOpts) {
    return oazapfts.fetchText(`/api/store/carts/${encodeURIComponent(cartId)}/line-items/${encodeURIComponent(lineItemId)}`, {
        ...opts,
        method: "DELETE"
    });
}
export function storeCreateCartOrder(cartId: number, opts?: Oazapfts.RequestOpts) {
